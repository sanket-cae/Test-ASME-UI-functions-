...
if not st.session_state.history:
    ...
    for idx, item in enumerate(st.session_state.history):
        ...
        # Updated card label featuring Variant Number explicitly
        card_label = f"📦 [{idx+1}] **Spec:** {spec} | **Grade:** {grade} | **Variant:** {variant} | **Source:** {source} | **Section:** {section} (Min. Tensile: {tensile} MPa)"
